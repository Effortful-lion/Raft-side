...
// net.Enable(endname, false) 真的会断开客户端连接吗？
...
// 不应延迟后续的 RPC（例如在 Enabled=true 之后）。
...
// 如果一个 RPC 在服务器中卡住，并且服务器
// 被 DeleteServer() 杀死，RPC 会被解除卡住吗？
