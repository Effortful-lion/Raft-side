...
![image-20260221184337988](https://gitee.com/young-lion/picture-bed/raw/master/202602211843037.png)
...
![image-20260221184420272](https://gitee.com/young-lion/picture-bed/raw/master/202602211844346.png)
...
**每个分片都由一个具体存储数据的哈希表和状态变量构成**。对状态机再抽象一层，即将 KV 的类型再抽象为一个接口，这样其不论是内存哈希表还是 LSM 都可扩展，shard 这一层就负责维护数据的状态，去重表和 KV 接口即可。
...
![image-20260221184447619](https://gitee.com/young-lion/picture-bed/raw/master/202602211844678.png)
...
![image-20260221184505875](https://gitee.com/young-lion/picture-bed/raw/master/202602211845936.png)
...
![image-20260221184524051](https://gitee.com/young-lion/picture-bed/raw/master/202602211845106.png)



![image-20260221184531583](https://gitee.com/young-lion/picture-bed/raw/master/202602211845645.png)
...
![image-20260221184547326](https://gitee.com/young-lion/picture-bed/raw/master/202602211845392.png)
...
3. **日志追赶**：如果Follower节点拒绝了AppendEntries RPC，那么Leade r节点会逐步后退自己的日志索引，然后重新发送AppendEntries RPC。这个过程会一直进行，直到Leader节点找到了与Follower节点日志一致的位置。
...
2. **投票决策（Voting Decisions）:**
   - 当节点投票给某个候选者时，它可能会选择持久化这个投票决策，以防止在  下一次选举中重复投票给同一个候选者。
